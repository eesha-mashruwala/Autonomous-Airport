...
This file provides a skeleton overview containing 3 major classes:
...
3) GroundOperations: a parent class that handles all discrete-time events in the system, including scheduling, take off and landing queues.
   
FlightDynamics operates on a Plane instance and collects telemetry 
